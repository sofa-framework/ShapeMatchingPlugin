...
******************************************************************************/
//
// C++ Interface: Mapped3DoFForceField
//
// Description: 
//
//
...
//
//
#ifndef SOFA_COMPONENT_FORCEFIELD_MAPPED3DOFFORCEFIELD_H
#define SOFA_COMPONENT_FORCEFIELD_MAPPED3DOFFORCEFIELD_H
...
class Mapped3DoFForceField : public core::behavior::ForceField<DataTypes>
{
public:
    SOFA_CLASS(SOFA_TEMPLATE(Mapped3DoFForceField, DataTypes), SOFA_TEMPLATE(core::behavior::ForceField, DataTypes));
    ...
    typedef typename defaulttype::Vec3dTypes Vectorial;

	typedef defaulttype::Mat<3,3,Real> InBlockType;         // *In* refers to output of the _mapping
    typedef defaulttype::Mat<3,3,Real> OutBlockType;        // *Out* refers to output of the _mapping
    typedef defaulttype::Mat<3,3,Real> MappingBlockType;
    typedef defaulttype::Mat<3,3,Real> TempBlockType;
...
protected:
        core::behavior::ForceField<Vectorial> *mappedForceField;
        sofa::core::Mapping< DataTypes, Vectorial > *mapping;
    core::behavior::MechanicalState<Vectorial>* mappedMO;
    ...
    Mapped3DoFForceField(core::behavior::MechanicalState<DataTypes>* /*object*/=NULL, const std::string& /*name*/="")
