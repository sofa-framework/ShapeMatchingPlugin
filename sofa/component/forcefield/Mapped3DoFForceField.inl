...
******************************************************************************/
#ifndef SOFA_COMPONENT_FORCEFIELD_MAPPED3DOFFORCEFIELD_INL
#define SOFA_COMPONENT_FORCEFIELD_MAPPED3DOFFORCEFIELD_INL
...
#include <iostream>
#include <fstream>
#include <sofa/component/forcefield/Mapped3DoFForceField.h>
...
void Mapped3DoFForceField<DataTypes>::bwdInit()
{
...
////void Mapped3DoFForceField<DataTypes>::addKToMatrix(sofa::defaulttype::BaseMatrix *mat, SReal k, unsigned int &offset)
template<class DataTypes>
void Mapped3DoFForceField<DataTypes>::addKToMatrix(const sofa::core::MechanicalParams* mparams /* PARAMS FIRST */, const sofa::core::behavior::MultiMatrixAccessor* matrix )
{
    ...
    //std::cout << this->getName() << ": " << *mappingMatrix << std::endl;
...
template <class DataTypes>
double Mapped3DoFForceField<DataTypes>::getPotentialEnergy(const MechanicalParams* /* PARAMS FIRST */, const DataVecCoord& ) const
{
    return(0.0);
}

template<class DataTypes>
void Mapped3DoFForceField<DataTypes>::draw(const core::visual::VisualParams* )
{
}
